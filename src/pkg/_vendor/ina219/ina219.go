// Source: https://github.com/NeuralSpaz/ti-ina219
// Copyright (c) 2015 NeuralSpaz (MIT license)
// Copied it here in order to make some adjustments to the configuration of the device
// (which is hard coded in the implementation).

//Texas Instruments INA219 high side current sensor

// Additions/changes marked with "CT"
